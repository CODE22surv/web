const SETTINGS = {
  ...
  zoomFactor: 1.35, // 1-> exactly the same zoom than for the art painting
...
function main(){
  ...
  WEBARROCKSFACE.init({
    ...
    callbackReady: function(errCode, spec){
      ...
      console.log('INFO: WebAR.rocks.face IS READY');
      check_isLoaded('WebAR.rocks.face');
    }, //end callbackReady()
